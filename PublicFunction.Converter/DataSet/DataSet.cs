...
namespace PublicFunction.Converter
{
    public class DataSetConverter
    {
        public interface IDataSet
        {
            ...
            public List<List<Dictionary<string, object>>> DataSetToList(ref System.Data.DataSet dataSet);
            public string DataSetToXml(System.Data.DataSet dataSet);
            public string DataSetToCsv(System.Data.DataSet dataSet, string delimiter = ",");
